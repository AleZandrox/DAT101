...
/*
lag en klasse TPoint med en konstruktør som tar inn x- og y- konstanter
*/
class TPoint{
    x = 0;
    y = 0;
...
En funksjon for å finne avstanden mellom TPoint objekter.
*/
...
export default {
     ...
     * @param {number} aX - The coordinate.
     * @param {number} aY - The coordinate.
